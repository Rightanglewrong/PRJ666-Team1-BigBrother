const awsconfig = {
    ...
    oauth: {
        domain: 'https://big-brother2-pool.auth.us-east-1.amazoncognito.com/login?client_id=69n73oh4j7t8ou9f1u9sqs8e3g&response_type=code&scope=email+openid+phone&redirect_uri=https%3A%2F%2Fbig-brother-psi.vercel.app%2Fdashboard',  // Your Cognito Hosted UI domain
        scope: ['email', 'openid', 'profile'],  // Scopes you need for authentication
        redirectSignIn: 'https://big-brother-psi.vercel.app/dashboard',  // URL to redirect after successful sign-in
        redirectSignOut: 'https://big-brother-psi.vercel.app/',  // URL to redirect after successful sign-out
